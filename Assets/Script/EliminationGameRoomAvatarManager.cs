...
public class EliminationGameRoomAvatarManager : MonoBehaviour
{
    ...
    public void NewAvatarElement(int bodyID, Color bodyColor, int UTID, Color UTColor, int LTID, Color LTColor, int hairID, Color hairColor, int eyesID, Color pupilColor, int eyelashesID, int eyebrowsID, Color eyebrowsColor, int noseID, int mouthID, string playerName, string playermessage)
    {
