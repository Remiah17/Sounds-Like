...
public class ScoreElement : MonoBehaviour
{
    ...
    public void NewScoreElement(string _username,int _onlinescore, int _place)
    {
        PlaceText.text = _place.ToString();
        UsernameText.text = _username;
        OnlineScoreText.text = _onlinescore.ToString();

    }

    public void NewAvatarElement(int bodyID, Color bodyColor, int UTID, Color UTColor, int LTID, Color LTColor, int hairID, Color hairColor, int eyesID, Color pupilColor, int eyelashesID, int eyebrowsID, Color eyebrowsColor, int noseID, int mouthID)
    {
